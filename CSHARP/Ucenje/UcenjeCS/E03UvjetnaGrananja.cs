...
namespace UcenjeCS
{
    internal class E03UvjetnaGrananja
    {
        public static void Izvedi ()
        {
            ...
            if (uvjet)
            {
                Console.WriteLine($"brtoj je {i}, ušli smo u true dio if naredbe");
            }
            ...
            // & provjeravaju se oba uvjedta bez obzira ako se na prvom padne (false)
            ...
            //u slučaju istog ponašanja s različitim vrijenostima u if i else dijelu
            //možemo pisati kraće
